...
// Alter existing tables if they were created before these columns were added
try {
...
try {
  db.exec("ALTER TABLE users ADD COLUMN email_otp_attempts INTEGER DEFAULT 0;");
} catch (e) {}
try {
  db.exec("ALTER TABLE users ADD COLUMN email_otp_last_sent_at TEXT;");
} catch (e) {}
